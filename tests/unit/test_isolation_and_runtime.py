...
from nexusai.core.errors import ToolExecutionError, ModelProviderError
...
async def test_provider_resilience_fallback_routing() -> None:
    ...
    runtime = ProviderRuntime(primary_provider=primary, fallback_provider=fallback, max_retries=2, backoff_seconds=0.1)
